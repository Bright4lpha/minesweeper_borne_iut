...
public class Score {
    ...
    public static void registerScore(Fenetre f, KeyboardArcade keyboard, Texture t, int s, String HighScorefile) {
        ...
        try {
            ...
            File in = new File("/home/johstar/Project/borne_arcade/fonts/PrStart.ttf"); // Ne pas oublier
        ...
        while (!done) {
            ...
            if (keyboard.isButtonATrigger() && indexSelec == 3)
                done
                 = true;
